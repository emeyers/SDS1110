...
Class material and functions for S&DS 1110: Introduction to Data Display and Analysis


## Installing the SDS1110 package

To install the SDS1110 package that contains functions that are useful for the
...
Once you have installed the SDS1110 package, you can use this package to install other packaged required by the class as well as LaTeX using the `SDS1110:::initial_setup()` function shown below. 
