...
#pie(drinks_table, col = rainbow(length(drinks_table)), main = "Pie chart of drinking behavior")
...
Note: Some pie charts [are more informative than others](http://robslink.com/SAS/democd91/pyramid_pie.htm)
